...
' 	timeout (ms) : maximum time for tests. By default : 30000 ms
' So it looks like :
' IsSpeaking_LoopTest.vbs /timeloop:100 /timeout:30000

' RETURN VALUES :
' -1 => LogFile/Server doesn't exist or there is an error
...
sIsSpeaking  = "IsSpeaking_Status.vbs"
...
Do
	...
	' === OLD METHOD BASED ON LOG FILES ===
	'	'	ISSPEAKING_LOG RETURN VALUES :
	...
	' === NEW METHOD BASED ON STATUS ===
	'	ISSPEAKING_STATUS RETURN VALUES :
	' -1 => There is an error (Server ...)
	'  0 => SARAH doesn't speak
	'  1 => SARAH is speaking
	iIsSpeaking = WshShell.Run(sScriptPath & sIsSpeaking, 1, true)
